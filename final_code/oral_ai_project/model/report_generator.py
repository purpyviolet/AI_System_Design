...
class ReportGenerator:
    def __init__(self):
        # 加载oral.json数据
        with open('D:\\华南理工\\工导2.0\\oral_ai_project\\oral_ai_project\\static\\oral.json', 'r', encoding='utf-8') as f:
    ...
    def create_pdf(self, report, output_path):
        ...
        class PDF(FPDF):
            def __init__(self):
                ...
                self.add_font("SimHei", "", "D:\\华南理工\\工导2.0\\AI_System_Design\\pdf_gen\\Ubuntu_18.04_SimHei.ttf", uni=True)
                self.set_font("SimHei", "", 13)
                self.add_page()

            def header(self):
                self.image("D:\\华南理工\\工导2.0\\oral_ai_project\\oral_ai_project\\static\\logo.png", 10, 8, 15)
